...
export default function PartialRequests() {
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-dashboard-muted text-sm">
            Manage incomplete event requests that need additional information
          </p>
        </div>
        ...
        <div className="bg-dashboard-sidebar rounded-lg border border-dashboard-border p-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-dashboard-muted">
              This page is under development. Partial requests management
